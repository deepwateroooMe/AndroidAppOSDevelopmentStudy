...
- https://blog.csdn.net/aila852/article/details/73692124

** How is UnityAction different from .NET's built-in Action? （第十楼的重要阐述）
- https://forum.unity.com/threads/how-is-unityaction-different-from-nets-built-in-action.288873/

** Unity中事件分发系统 EventDispatcher详解
- http://gad.qq.com/article/detail/34567

** Unity 3D 消息事件系统 NotificationCenter、CEventDispatcher事件分发机制
- https://blog.csdn.net/u012632851/article/details/56014485

** Unity统一管理回调函数 -- 观察者模式
- http://www.unity.5helpyou.com/2826.html

** Unity教程之 -- Unity3d中消息事件的封装与运用
- http://www.unity.5helpyou.com/2689.html

** Unity4.6的使用匿名delegate处理uGUI控件事件绑定 (多个命令按钮的委托机制）
- http://www.it165.net/pro/html/201411/27977.html

** Unity3D游戏开发之在iTween中使用事件机制
- http://www.it165.net/pro/html/201504/38746.html

** 【Unity3D开发】DOTween 插件仿写
- https://www.jianshu.com/p/2a201125159a
